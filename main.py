...
version2 = requests.get("https://otsploit-console-extra-utilities.otiopo.repl.co/utilities/version.txt")

if version == str(version2.text):
    colorama.init()
...
elif version2.status_code == 200:
    showerror("OtSploit Error", "You Are Using An Outated Version of OtSploit Currect Version You Use: " + version + ", Latest Version: " + version2.text)
else:
    showwarning("OtSploit Error", "Server Error")
